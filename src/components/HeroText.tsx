...
export const HeroText = () => {
  return (
    <div className="flex gap-[100px] mt-[474px]">
      ...
      <div className="">
        <h3 className="text-xl text-white font-gilroy">Мы поможем сопроводить сделку на покупку складов, от момента просмотра до получения ключей и полного пакета документов</h3>
